...
const Hero = () => {
  return (
    ...
    <div className="bg-primary-content">
      ...
      <nav className="relative bg-primary-a50 py-4 flex justify-between items-center z-10">
        <motion.div
      ...
      <section
        ...
        <div className="container mx-auto px-40 h-full flex items-center">
